...
import { CreateScheduleInput, UpdateScheduleInput } from '../types/express/schedule';
...
export const createScheduleService = async (data: CreateScheduleInput) => {
  return await prisma.schedule.create({ data });
};

// export const createSchedulesFromExcel = async (fileBuffer: Buffer): Promise<Schedule[]> => {
...
export const getDetailScheduleService = async (id: string) => {
...
export const updateScheduleService = async (id: string, data: UpdateScheduleInput) => {
